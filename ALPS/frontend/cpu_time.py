...
def trace_print(stop_event, exp_cpu):
    print("Mock trace_print: BPF tracing disabled for Ghost integration.")
    # Keep thread alive until stopped to mimic original behavior
    stop_event.wait()

def update_cpuT(exp_cpu, exp_result):
    pass

def read_cpuT(file_path):
    # Return an empty list or default values if workload.py needs it
    return {}
